$(document).ready(function() {
    ...
    $(document).on('click', '.add-othertransaction', function() {
        ...
        if(!orgId)
        {
            ...
            OrgChangeSites('#rot_org', '#rot_site', '#add_materialconsumption');
            $('#rot_transactiontype').html("<option selected disabled value=''>Select Transaction Type</option>").prop('disabled',true);
            OrgChangeTransactionTypes('#rot_org', '#rot_transactiontype', '#add_materialconsumption',true);
            
            $('.rot_itemgeneric').html("<option selected disabled value=''>Select Item Generic</option>").prop('disabled', true);
            OrgChangeInventoryGeneric('#rot_org', '.rot_itemgeneric', '#add_materialconsumption');
            ...
            fetchTransactionTypes(orgId, '#rot_transactiontype', true, function(data) {
        ...
        SiteChangeActivatedServiceLocation('#rot_site','#rot_inv_location', '#add_othertransaction');
    ...
    //                 console.log(error);
    //             },response.siteId);
    //             OrgChangeSites('#u_rot_org', '#u_rot_site', '#activate_cc');

    //             $('#u_rot_transactiontype').html("<option selected value='"+response.transactionTypeId+"'>" + response.transactionType + "</option>").trigger('change');
    //             fetchTransactionTypes(response.orgId, '#u_rot_transactiontype', true, function(data) {
    //                 if (data && data.length > 0) {
    //                     $.each(data, function(key, value) {
    ...
    //                 } 
    //             });
    //             OrgChangeTransactionTypes('#u_rot_org', '#u_rot_transactiontype', '#add_materialconsumption',true);
    ...
    //             $(document).off('change', '#u_rot_transactiontype').on('change', '#u_rot_transactiontype', function() {
    //                 let transactionTypeID = $(this).val();
    //                 let siteId = $('#u_rot_site').val();  // you must already have a selected site
    //                 if (!siteId) {
    //                     Swal.fire({
    //                         icon: 'warning',
    //                         title: 'Site Required',
    ...
    // $(document).on('change', '#rot_transactiontype', function() {
    //     let transactionTypeId = $(this).val();
