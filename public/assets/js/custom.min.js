...
function handleBatchNumberCheck(orgId, siteId, genericId, brandId, $brand, currentRow, skipPlaceholder = false) {
...
function BrandChangeBatchAndExpiry(org, site, generic, brand, batch, expiry, form) {
    ...
    //     .on('change.BrandChangeBatch', function(e) {
        $brand.on('change.BrandChangeBatch', function(e) {
            ...
            handleBatchNumberCheck(orgId, siteId, genericId, brandId, $brand, currentRow, true); // or true based on your needs
