                            ...
                            <div class="row justify-content-center align-items-center">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group has-custom m-b-5">
                                                ...
                                                <select class="form-control selecter p-0" id="fb_st" style="color:#222d32">
                                                    <option selected disabled >Select Service Types</option>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group has-custom m-b-5">
                                                ...
                                                <select class="form-control selecter p-0" id="fb_sg" style="color:#222d32">
                                                    <option selected disabled >Select Service Groups</option>
                                                    @foreach ($serviceGroups as $serviceGroup)
                                                        <option value="{{ $serviceGroup['id'] }}"> {{ $serviceGroup['name'] }}</option>
                                                    @endforeach
                                                </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            <div class="form-group has-custom m-b-5">
                                                <label class="filterlabel">Service Units</label>
                                                <select class="form-control selecter p-0" id="fb_su" style="color:#222d32">
                                                    <option selected disabled >Select Service Units</option>
                                                    @foreach ($serviceUnits as $serviceUnit)
                                                        <option value="{{ $serviceUnit['id'] }}"> {{ $serviceUnit['name'] }}</option>
                                                    @endforeach
                                                </select>
