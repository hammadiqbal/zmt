...
<!-- ============================================================== -->
        ...
        <div class="page-wrapper">
            ...
            @if($user->name)
            <center><h2>Welcome {{ ucwords($user->name) }}</h2></center>
            @endif
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table class="table browser m-t-30 no-border">
                                    <tbody>
                                        <tr>
                                            <td style="width:40px"><img src="{{ asset('assets/lib/images/browser/chrome-logo.png') }}" alt=logo /></td>
                                            <td>Google Chrome</td>
                                            <td class="text-right"><span class="label label-light-info">23%</span></td>
                                        </tr>
                                        <tr>
                                            <td><img src="{{ asset('assets/lib/images/browser/firefox-logo.png') }}" alt=logo /></td>
                                            <td>Mozila Firefox</td>
                                            <td class="text-right"><span class="label label-light-success">15%</span></td>
                                        </tr>
                                        <tr>
                                            <td><img src="{{ asset('assets/lib/images/browser/safari-logo.png') }}" alt=logo /></td>
                                            <td>Apple Safari</td>
                                            <td class="text-right"><span class="label label-light-primary">07%</span></td>
                                        </tr>
                                        <tr>
                                            <td><img src="{{ asset('assets/lib/images/browser/internet-logo.png') }}" alt=logo /></td>
                                            <td>Internet Explorer</td>
                                            <td class="text-right"><span class="label label-light-warning">09%</span></td>
                                        </tr>
                                        <tr>
                                            <td><img src="{{ asset('assets/lib/images/browser/opera-logo.png') }}" alt=logo /></td>
                                            <td>Opera mini</td>
