...
<body>
    <div class="container">
        ...
        <h2 class="mt-4">Your Organization Registration Details:</h2>
        <ul>
            <li><strong>Name:</strong> {{ $orgName }}</li>
            <li><strong>Code:</strong> {{ $orgCode }}</li>
            <li><strong>Remarks:</strong> {{ $orgRemarks }}</li>
            ...
            <li><strong>Focal Person Name:</strong> {{ $orgpersonname }}</li>
            <li><strong>Email:</strong> {{ $orgpersonemail }}</li>
            <li><strong>Website:</strong> {{ $orgwebsite }}</li>
            <li><strong>GPS:</strong> {{ $orggps }}</li>
            <li><strong>Mobile #:</strong> {{ $orgcell }}</li>
            <li><strong>Landline #:</strong> {{ $orglandline }}</li>
